...
const UploadPage = () => {
  ...
  return (
    <div className="  w-full overflow-auto bg-[#141414]">
      <div className="bg-[#141414] flex items-center flex-col m-[56px]  text-white">
        ...
        {/* Inputs */}
        <div className="flex items-center flex-col justify-center w-full mt-3">
          <div className="flex flex-col md:w-[50%] w-full mx-auto">
          ...
          <div className="flex flex-col md:w-[50%] w-full  lg:flex-row gap-4 lg:gap2 items-center justify-center px-3">
          ...
          <div className="p-10 lg:p-10  md:mb-[39.5px]">
