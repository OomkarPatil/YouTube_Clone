...
const SideBar = () => {
  return (
    <div className="flex flex-col flex-[0.16 1] box-border h-[93vh] overflow-hidden hover:overflow-y-scroll fixed top-[55px] left-0 p-[14px] text-white bg-[#141414] w-[250px] scrollbar-thin scrollbar-thumb-[#535151] scrollbar-thumb-rounded-full scrollbar-track-black ">
